...
if __name__ == '__main__':
    model = pd.read_csv('data/EASER_goodreads.tsv', sep='\t')
    obj1 = 'Recall'
    obj2 = 'APLT'
    population = 18070
    ...
    # if calibration:
    c_pdu = obj.pdu(personalized_up, 'goodreads', scale, calibration=True)
    pdu = obj.pdu([utopia_point] * population, 'goodreads', scale, calibration=False)
